import{s,k as E,m as Ue,n as Be,j as n,o as U,t as I,p as vt,q as gt,v as xt,r as P,u as oe,w as yt,x as bt,L as He,y as wt,z as Ct,A as Ot,B as _t,C as St,D as jt,G as Et,H as kt}from"./index-d5a3f81a.js";import{C as ze,A as Mt,p as qe,a as Ke,D as Tt,b as Rt,L as Pt,B as Dt,c as At,d as Ft}from"./index-a131d242.js";import{s as Nt,a as Wt,b as Lt,c as $t,C as It,T as Ut,M as Bt,d as Ge,e as Ht,B as je,f as zt,g as qt,h as Kt,A as Gt,i as Vt,j as Yt,k as Zt,l as Jt}from"./Reacord.styled-23de7adb.js";import{R as Qt}from"./RecommendedList-d9c8c59a.js";var Ve={exports:{}},Xt="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",en=Xt,tn=en;function Ye(){}function Ze(){}Ze.resetWarningCache=Ye;var nn=function(){function t(a,l,c,d,i,w){if(w!==tn){var g=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw g.name="Invariant Violation",g}}t.isRequired=t;function e(){return t}var o={array:t,bigint:t,bool:t,func:t,number:t,object:t,string:t,symbol:t,any:t,arrayOf:e,element:t,elementType:t,instanceOf:e,node:t,objectOf:e,oneOf:e,oneOfType:e,shape:e,exact:e,checkPropTypes:Ze,resetWarningCache:Ye};return o.PropTypes=o,o};Ve.exports=nn();var Je=Ve.exports;const on=s.div`
  width: 300px;
...
`,Sn=s.p`
  color: var(--primary-color-grey);
`,jn=()=>{const t=`${I.palette.litegreen.main}`,e=`${I.palette.pink.main}`,o=`${I.palette.yellow.main}`,a=`${I.palette.grey.main}`,l=E(Ue),c=E(vt),d=E(gt),i=E(xt),w=E(Nt),g=E(Wt),h=E(Lt),m=E($t);return n.jsxs(xn,{children:[n.jsx(wn,{children:"Food"}),n.jsxs(yn,{children:[n.jsxs(Cn,{children:[n.jsx(Qe,{dailyGoal:l,filledValue:w,bgColor:t}),n.jsxs(On,{children:[n.jsx(_n,{children:w||0}),n.jsx(Sn,{children:"calories"})]})]}),n.jsxs(bn,{children:[n.jsx(ve,{children:n.jsx(me,{title:"Carbonohidrates",bgColor:e,dailyGoal:c,filledValue:g})}),n.jsx(ve,{children:n.jsx(me,{title:"Protein",bgColor:o,dailyGoal:d,filledValue:h})}),n.jsx(ve,{children:n.jsx(me,{title:"Fat",bgColor:a,dailyGoal:i,filledValue:m})})]})]})]})},En=s.div`
  height: 100vh;
  width: 100vw;
...
`,Er=({setName:t,setColories:e,setCarbogidrate:o,setProtein:a,setFat:l,name:c,calories:d,carbogidrate:i,protein:w,fat:g})=>n.jsxs(Sr,{children:[n.jsx(xe,{value:c,placeholder:"The name of the product or dish",onChange:h=>{t(h.target.value)}}),n.jsx(xe,{type:"number",min:1,onChange:h=>{o(h.target.value)},value:i,placeholder:"Carbonoh"}),n.jsx(xe,{min:1,type:"number",onChange:h=>{a(h.target.value)},value:w,placeholder:"Protein"}),n.jsxs(jr,{children:[n.jsx(Ie,{min:1,type:"number",onChange:h=>{l(h.target.value)},value:g,placeholder:"Fat"}),n.jsx(Ie,{min:1,type:"number",onChange:h=>{e(h.target.value)},value:d,placeholder:"Calories"}),n.jsx("svg",{style:{display:"inline-block",width:"20px",height:" 20px",fill:"white"},children:n.jsx("use",{href:`${U}#trash-delete`})})]})]}),kr={content:{maxWidth:"calc(100vw - 48px)",maxHeight:"calc(100vh - 24px)",top:"50%",left:"50%",right:"auto",bottom:"auto",marginRight:"-50%",transform:"translate(-50%, -50%)",border:"none",background:"none"},overlay:{backgroundColor:"rgba(0, 0, 0, 0.8)",zIndex:"1200",width:"100vw",height:"100vh"}};lt.setAppElement("#root");const Mr=({stateModal:t,closeModal:e,typefood:o})=>{const a=oe(),[l,c]=P.useState(""),[d,i]=P.useState(""),[w,g]=P.useState(""),[h,m]=P.useState(""),[y,O]=P.useState(""),[_,R]=P.useState([1]),$={typeFood:o,userFood:[{name:l,calories:d,nutrition:{carbogidrate:w,protein:h,fat:y}}]},A=b=>{b.preventDefault(),a(_t($)),e()},H=[_],C=()=>{R(b=>{console.log(b);const u=b.lenght-1;[...b,b[u]+1]})};return n.jsx(lt,{isOpen:t,onRequestClose:e,style:kr,children:n.jsxs(It,{children:[n.jsx(Ut,{children:"Record your meal"}),n.jsxs(Bt,{style:{marginTop:"24px"},children:[n.jsx(Ge,{src:"src/assets/images/Breakfast.png"}),n.jsx(Ht,{})]}),n.jsxs("form",{onSubmit:A,children:[H.map((b,u)=>n.jsx(Er,{setName:c,setColories:i,setCarbogidrate:g,setProtein:m,setFat:O,name:l,calories:d,carbogidrate:w,protein:h,fat:y},u)),n.jsxs(je,{onClick:C,type:"button",children:[n.jsx(_r,{children:n.jsx("use",{href:`${U}#icon-add-converted`})}),"Add more"]}),n.jsxs(zt,{children:[n.jsx(je,{type:"submit",children:"Confirm"}),n.jsx(qt,{onClick:e,type:"button",children:"Cancel"})]})]})]})})},Tr=({meal:t,title:e,totalCarbs:o,totalProtein:a,totalFat:l,typefood:c,src:d})=>{const i=oe(),w=O=>{i(St({userFood:{},typeFood:O}))};E(Kt),e.toLowerCase();const[g,h]=P.useState(!1),m=()=>h(!0),y=()=>h(!1);return n.jsxs(po,{children:[n.jsx(Mr,{closeModal:y,stateModal:g,typefood:c}),n.jsxs(ho,{children:[n.jsx(Ge,{src:d}),n.jsx(fo,{children:e})]}),n.jsx(uo,{children:(t==null?void 0:t.length)>0?n.jsxs(n.Fragment,{children:[n.jsxs(ge,{children:["Carbonohidrates: ",o]}),n.jsxs(ge,{children:["Protein: ",a]}),n.jsxs(ge,{children:["Fat: ",l,n.jsx(mo,{onClick:()=>w(e.toLowerCase()),children:n.jsx("use",{href:`${U}#trash-delete`})})]})]}):n.jsxs(go,{id:c,"data-site":c,onClick:m,children:[n.jsx(Gt,{children:"Record your meal"}),n.jsx(vo,{children:n.jsx("use",{href:`${U}#icon-add-converted`})})]})})]})},Rr="/Healthy_life/assets/Breakfast-ebbae9d6.png",Pr="/Healthy_life/assets/Dinner-3e075f11.png",Dr="/Healthy_life/assets/Lunch-b9834f5c.png",Ar="/Healthy_life/assets/Snack-986b08ce.png",Fr=[Rr,Dr,Pr,Ar],Nr=()=>{const t=E(Vt),e=E(Yt),o=E(Zt),a=E(Jt),l={breakfast:t,lunch:e,dinner:o,snack:a},c=["breakfast","lunch","dinner","snack"];let d=0,i=0,w=0,g=0,h=0,m=0,y=0,O=0,_=0,R=0,$=0,A=0;(t==null?void 0:t.length)>0&&(d=t.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.fat)},0),i=t.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.protein)},0),w=t.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.carbogidrate)},0)),(e==null?void 0:e.length)>0&&(g=e.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.fat)},0),h=e.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.protein)},0),m=e.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.carbogidrate)},0)),(o==null?void 0:o.length)>0&&(y=o.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.protein)},0),O=o.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.carbogidrate)},0),_=o.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.fat)},0)),(a==null?void 0:a.length)>0&&(R=a.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.fat)},0),$=a.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.protein)},0),A=a.reduce((C,b)=>{var u;return C+((u=b.nutrition)==null?void 0:u.carbogidrate)},0));const H={breakfast:{carbs:w,protein:i,fat:d},lunch:{carbs:m,protein:h,fat:g},dinner:{carbs:O,protein:y,fat:_},snack:{carbs:A,protein:$,fat:R}};return n.jsxs(ao,{children:[n.jsxs(io,{children:[n.jsx(lo,{children:"Diary"}),n.jsx(so,{to:"/diary",children:"See more"})]}),n.jsx(co,{children:c.map((C,b)=>n.jsx(Tr,{meal:l[C],typefood:C,title:C,totalCarbs:H[C].carbs,totalProtein:H[C].protein,totalFat:H[C].fat,src:Fr[b]},C))})]})},Wr=s.div`
  display: flex;
  flex-direction: column;
  gap: 20px;
  padding-bottom: 80px;
