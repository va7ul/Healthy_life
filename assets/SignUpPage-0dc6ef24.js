import{r as d,s as t,N as J,j as e,u as K,a as X}from"./index-f74ee9e1.js";import{n as S}from"./notiflix-notify-aio-73587518.js";import{i as Z}from"./welcomepage-690c85c9.js";import{i as ee,a as te}from"./eye-off-01faa7db.js";import{c as k,a as j,F as B,b as $,d as n,E as u,e as z}from"./index.esm-54be17e7.js";const A=(i="",a={})=>{const[c,x]=d.useState(i),[p,l]=d.useState(null),[m,r]=d.useState(!1),f=()=>{if(!a)return;const{required:b,minLength:h,maxLength:y,pattern:w}=a;b&&!c.trim()?l("This field is required"):h&&c.length<h?l(`Minimum length is ${h} characters`):y&&c.length>y?l(`Maximum length is ${y} characters`):w&&!w.test(c)?l("Invalid format"):l(null)};return{value:c,error:p,touched:m,onChange:b=>{x(b.target.value),m&&f()},onBlur:()=>{r(!0),f()}}},ie=()=>{const i=document.getElementById("myInput");i.type==="password"?i.type="text":i.type="password"},ne=t.div`
  margin: 0 auto;
  padding: 10px;
