import{r as s,s as t,N as J,j as e,u as K,a as X}from"./index-95993abd.js";import{n as N}from"./notiflix-notify-aio-cd51e5d6.js";import{i as Z}from"./welcomepage-690c85c9.js";import{c as w,a as T,F as k,b as S,d as i,E as x,e as G}from"./index.esm-31cdef9e.js";const B=(n="",o={})=>{const[l,m]=s.useState(n),[d,c]=s.useState(null),[g,a]=s.useState(!1),f=()=>{if(!o)return;const{required:b,minLength:h,maxLength:y,pattern:j}=o;b&&!l.trim()?c("This field is required"):h&&l.length<h?c(`Minimum length is ${h} characters`):y&&l.length>y?c(`Maximum length is ${y} characters`):j&&!j.test(l)?c("Invalid format"):c(null)};return{value:l,error:d,touched:g,onChange:b=>{m(b.target.value),g&&f()},onBlur:()=>{a(!0),f()}}},ee=()=>{const n=document.getElementById("myInput");n.type==="password"?n.type="text":n.type="password"},te="/Healthy_life/assets/eye-1e855825.svg",ne="/Healthy_life/assets/eye-off-89186890.svg",ie=t.div`
  margin: 0 auto;
  padding: 10px;
