...
`;var ce={exports:{}},U={},pe={exports:{}},T={},de={exports:{}};(function(t,e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=x;/*!
...
`,No="/Healthy_life/assets/Breakfast-ebbae9d6.png",Ao="/Healthy_life/assets/Dinner-3e075f11.png",Do="/Healthy_life/assets/Lunch-b9834f5c.png",Lo="/Healthy_life/assets/Snack-986b08ce.png",Io={content:{maxWidth:"calc(100vw - 48px)",maxHeight:"calc(100vh - 24px)",top:"50%",left:"50%",right:"auto",bottom:"auto",marginRight:"-50%",transform:"translate(-50%, -50%)",border:"none",background:"#0F0F0F"},overlay:{backgroundColor:"rgba(0, 0, 0, 0.8)",zIndex:"1200",width:"100vw",height:"100vh"}};We.setAppElement("#root");const Tn=({stateModal:t,closeModal:e,typefood:n})=>{const a=Xe(),i={name:"",carbogidrate:"",protein:"",fat:"",calories:""},h=r=>{let y={typeFood:n,userFood:r.products.map(f=>({name:f.name,calories:f.calories,nutrition:{carbogidrate:f.carbogidrate,protein:f.protein,fat:f.fat}}))};a(nt(y)),e()},b=r=>{if(n==="breakfast")return No;if(n==="dinner")return Ao;if(n==="lunch")return Do;if(n==="snack")return Lo};return v.jsx(We,{isOpen:t,onRequestClose:e,style:Io,children:v.jsxs(Fo,{children:[v.jsx(dt,{children:"Record your meal"}),v.jsxs(st,{style:{marginTop:"24px"},children:[v.jsx(pt,{src:b(),alt:n}),v.jsx(ct,{children:Ze(n)})]}),v.jsx(et,{initialValues:{products:[i]},onSubmit:r=>h(r),children:({values:r})=>v.jsxs(tt,{children:[v.jsx(ot,{name:"products",children:({remove:y,push:f})=>v.jsxs("div",{children:[r.products.map((x,s)=>v.jsxs(Eo,{children:[v.jsx(wo,{name:`products.${s}.name`,placeholder:"The name of the product or dish",value:r.products[s].name}),v.jsx(Oo,{name:`products.${s}.carbogidrate`,placeholder:"Carbonoh.",value:r.products[s].carbogidrate,type:"number",min:1}),v.jsx(Co,{name:`products.${s}.protein`,placeholder:"Protein",value:r.products[s].protein,min:1,type:"number"}),v.jsxs(ko,{children:[v.jsx(_o,{name:`products.${s}.fat`,placeholder:"Fat",value:r.products[s].fat,min:1,type:"number"}),v.jsx(So,{name:`products.${s}.calories`,placeholder:"Calories",value:r.products[s].calories,min:1,type:"number"}),v.jsx(To,{"data-set":s,type:"button",onClick:m=>{const g=m.currentTarget.dataset.set;r.products.length===1&&e(),y(g)},children:v.jsx("svg",{style:{display:"inline-block",width:"20px",height:" 20px",fill:"#E3FFA8"},children:v.jsx("use",{href:`${ye}#trash-delete`})})})]})]},s)),v.jsxs(Mo,{type:"button",onClick:()=>f(i),children:[v.jsx(Po,{children:v.jsx("use",{href:`${ye}#icon-add-converted`})}),"Add more"]})]})}),v.jsxs(ut,{children:[v.jsx(ft,{type:"submit",children:"Confirm"}),v.jsx(Ro,{onClick:e,type:"button",children:"Cancel"})]})]})})]})})};export{gn as $,Pn as A,No as B,bn as C,Ao as D,Xo as E,en as F,tn as G,nn as H,En as I,cn as J,pn as K,Do as L,Tn as M,ln as N,un as O,Zo as P,fn as Q,wn as R,Lo as S,dt as T,dn as U,rn as V,Yo as W,hn as X,mn as Y,vn as Z,yn as _,qo as a,Bo as a0,Ko as b,Vo as c,pt as d,Wo as e,Ho as f,jo as g,$o as h,xn as i,st as j,ct as k,On as l,Cn as m,kn as n,_n as o,Sn as p,ut as q,ft as r,zo as s,Mn as t,sn as u,Go as v,Jo as w,Qo as x,on as y,an as z};
