import{s,k as E,m as $e,n as Le,j as n,o as L,t as $,p as ft,q as ht,v as mt,r as K,u as re,w as vt,x as gt,L as Ue,y as xt,z as yt,A as bt,b as wt,d as Ct,F as Ot,B as _t,C as St,D as jt,G as Et,H as kt,I as Mt,J as Tt}from"./index-42cfa5f0.js";import{C as Ie,A as Pt,p as Be,a as He,D as Rt,b as Dt,L as Ft,B as At,c as Nt,d as Wt}from"./index-7cce5a3f.js";import{s as $t,a as Lt,b as Ut,c as It,C as Bt,T as Ht,M as zt,d as ze,e as qt,B as Kt,f as Gt,g as Vt,A as Yt,h as Jt,i as Zt,j as Qt,k as Xt}from"./Reacord.styled-92b2d9d5.js";import{R as en}from"./RecommendedList-7ef35e90.js";var qe={exports:{}},tn="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",nn=tn,on=nn;function Ke(){}function Ge(){}Ge.resetWarningCache=Ke;var rn=function(){function t(a,l,c,d,i,x){if(x!==on){var y=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw y.name="Invariant Violation",y}}t.isRequired=t;function e(){return t}var o={array:t,bigint:t,bool:t,func:t,number:t,object:t,string:t,symbol:t,any:t,arrayOf:e,element:t,elementType:t,instanceOf:e,node:t,objectOf:e,oneOf:e,oneOfType:e,shape:e,exact:e,checkPropTypes:Ge,resetWarningCache:Ke};return o.PropTypes=o,o};qe.exports=rn();var Ve=qe.exports;const an=s.div`
  width: 300px;
...
`,En=s.p`
  color: var(--primary-color-grey);
`,kn=()=>{const t=`${$.palette.litegreen.main}`,e=`${$.palette.pink.main}`,o=`${$.palette.yellow.main}`,a=`${$.palette.grey.main}`,l=E($e),c=E(ft),d=E(ht),i=E(mt),x=E($t),y=E(Lt),f=E(Ut),h=E(It);return n.jsxs(bn,{children:[n.jsx(On,{children:"Food"}),n.jsxs(wn,{children:[n.jsxs(_n,{children:[n.jsx(Ye,{dailyGoal:l,filledValue:x,bgColor:t}),n.jsxs(Sn,{children:[n.jsx(jn,{children:x||0}),n.jsx(En,{children:"calories"})]})]}),n.jsxs(Cn,{children:[n.jsx(ge,{children:n.jsx(ve,{title:"Carbonohidrates",bgColor:e,dailyGoal:c,filledValue:y})}),n.jsx(ge,{children:n.jsx(ve,{title:"Protein",bgColor:o,dailyGoal:d,filledValue:f})}),n.jsx(ge,{children:n.jsx(ve,{title:"Fat",bgColor:a,dailyGoal:i,filledValue:h})})]})]})]})},Mn=s.div`
  height: 100vh;
  width: 100vw;
...
`,Nn=({isModalOpen:t,setIsModalOpen:e})=>{const[o,a]=K.useState(0),l=re(),c=d=>{d.preventDefault(),l(vt({value:o})),e(!1)};return K.useEffect(()=>{const d=i=>{i.code==="Escape"&&e(!1)};return t?(document.addEventListener("keydown",d),document.body.style.overflow="hidden"):document.body.style.overflow="unset",()=>{document.removeEventListener("keydown",d),document.body.style.overflow="unset"}},[t,e]),n.jsx(Mn,{onClick:()=>e(!1),children:n.jsxs(Tn,{onClick:d=>d.stopPropagation(),children:[n.jsx(Dn,{children:"Add water intake"}),n.jsxs(Pn,{onSubmit:c,children:[n.jsxs("label",{children:["How much water",n.jsx(Fn,{name:"waterIntake",type:"number",placeholder:"Enter milliliters",onChange:d=>a(Number(d.target.value)),value:o||"",min:1})]}),n.jsx(Rn,{type:"submit",children:"Confirm"}),n.jsx(An,{type:"button",onClick:()=>e(!1),children:"Cancel"})]})]})})};Ie.register(Dt,Ft,At,Nt,Be,He);const Wn={responsive:!0,aspectRatio:.364,borderRadius:20,scales:{x:{ticks:{display:!1,padding:0},grid:{drawTicks:!1,drawBorder:!1}},y:{beginAtZero:!0,ticks:{display:!1},grid:{drawTicks:!1,drawBorder:!1}}},plugins:{legend:{display:!1},title:{display:!1},tooltip:{enabled:!1}}},$n=({waterIntake:t})=>{const e={labels:["Intake"],datasets:[{label:"Water",data:[t],backgroundColor:`${$.palette.violet.main}`,hoverBackgroundColor:`${$.palette.violet.main}`,barPercentage:1.001,categoryPercentage:1.001,grouped:!1},{label:"Dataset 2",data:[100],barPercentage:1.001,categoryPercentage:1.001}]};return n.jsx(Wt,{data:e,options:Wn})},Ln=t=>t.dailyWaterStatistics.consumedWater.value,Un=t=>t.dailyWaterStatistics.consumedWater._id,In=s.div`
  width: 300px;
...
`,Kr=()=>{const t=re();return K.useEffect(()=>{t(kt()),t(Mt()),t(Tt())},[t]),n.jsxs(n.Fragment,{children:[n.jsx(io,{}),n.jsxs(Ir,{children:[n.jsx(Ur,{}),n.jsx(en,{})]})]})};export{Kr as default};
