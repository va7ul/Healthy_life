import{v as me,w as ye,r as h,x as ve,y as Ce,_ as k,j as o,z as x,A as T,B as j,C as we,T as Fe,D as Me,E as ke,t as v,F as Te,I as je,S as Re,M as $e,s as u,e as C,G as R,H as $,J as S,K as B,O as M,P as Se,Q as A,R as Be,L as ze,U as Ae,u as De,V as Pe,b as Le,W as q}from"./index-c53e05d9.js";import{C as oe,b as ne,L as se,P as ae,e as ie,c as le,p as re,i as ce,a as de,f as pe}from"./index-ec647154.js";const We=["className","component"];function He(e={}){const{themeId:t,defaultTheme:s,defaultClassName:n="MuiBox-root",generateClassName:a}=e,i=me("div",{shouldForwardProp:c=>c!=="theme"&&c!=="sx"&&c!=="as"})(ye);return h.forwardRef(function(g,l){const r=ve(s),p=Ce(g),{className:m,component:b="div"}=p,y=k(p,We);return o.jsx(i,x({as:b,ref:l,className:T(m,a?a(n):n),theme:t&&r[t]||r},y))})}const Oe=j("MuiBox",["root"]),Ne=Oe,Ie=we(),Ee=He({themeId:Fe,defaultTheme:Ie,defaultClassName:Ne.root,generateClassName:Me.generate}),Ue=Ee,_e=ke`
