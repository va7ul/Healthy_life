...
`,vt=h.button`
  ...
  color: var(--primary-color-grey);
  border: none;
`;var ce={exports:{}},W={},ue={exports:{}},P={},pe={exports:{}};(function(t,e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=b;/*!
...
`,Mn="/Healthy_life/assets/Breakfast-ebbae9d6.png",Tn="/Healthy_life/assets/Dinner-3e075f11.png",Rn="/Healthy_life/assets/Lunch-b9834f5c.png",Pn="/Healthy_life/assets/Snack-986b08ce.png",Fn={content:{maxWidth:"calc(100vw - 48px)",maxHeight:"calc(100vh - 24px)",top:"50%",left:"50%",right:"auto",bottom:"auto",marginRight:"-50%",transform:"translate(-50%, -50%)",border:"none",background:"none"},overlay:{backgroundColor:"rgba(0, 0, 0, 0.8)",zIndex:"1200",width:"100vw",height:"100vh"}};Ie.setAppElement("#root");const io=({stateModal:t,closeModal:e,typefood:o})=>{const a=Ze(),i={name:"",carbogidrate:"",protein:"",fat:"",calories:""},f=r=>{let y={typeFood:o,userFood:r.products.map(d=>({name:d.name,calories:d.calories,nutrition:{carbogidrate:d.carbogidrate,protein:d.protein,fat:d.fat}}))};a(rt(y)),e()},x=r=>{if(o==="breakfast")return Mn;if(o==="dinner")return Tn;if(o==="lunch")return Rn;if(o==="snack")return Pn};return v.jsx(Ie,{isOpen:t,onRequestClose:e,style:Fn,children:v.jsxs(dt,{children:[v.jsx(ft,{children:"Record your meal"}),v.jsxs(ct,{style:{marginTop:"24px"},children:[v.jsx(ut,{src:x(),alt:o}),v.jsx(pt,{children:et(o)})]}),v.jsx(tt,{initialValues:{products:[i]},onSubmit:r=>f(r),children:({values:r})=>v.jsxs(nt,{children:[v.jsx(ot,{name:"products",children:({remove:y,push:d})=>v.jsxs("div",{children:[r.products.map((b,l)=>v.jsxs(Cn,{children:[v.jsx(z,{name:`products.${l}.name`,placeholder:"The name of the product or dish",value:r.products[l].name}),v.jsx(z,{name:`products.${l}.carbogidrate`,placeholder:"Carbonoh.",value:r.products[l].carbogidrate,type:"number",min:1}),v.jsx(z,{name:`products.${l}.protein`,placeholder:"Protein",value:r.products[l].protein,min:1,type:"number"}),v.jsx(z,{name:`products.${l}.fat`,placeholder:"Fat",value:r.products[l].fat,min:1,type:"number"}),v.jsx(z,{name:`products.${l}.calories`,placeholder:"Calories",value:r.products[l].calories,min:1,type:"number"}),v.jsx("button",{"data-set":l,type:"button",onClick:m=>{const g=m.currentTarget.dataset.set;r.products.length===1&&e(),y(g)},children:v.jsx("svg",{style:{display:"inline-block",width:"20px",height:" 20px",fill:"white"},children:v.jsx("use",{href:`${ye}#trash-delete`})})})]},l)),v.jsxs(En,{type:"button",onClick:()=>d(i),children:[v.jsx(Sn,{children:v.jsx("use",{href:`${ye}#icon-add-converted`})}),"Add more"]})]})}),v.jsxs(mt,{children:[v.jsx(ht,{type:"submit",children:"Confirm"}),v.jsx(vt,{onClick:e,type:"button",children:"Cancel"})]})]})})]})})};export{ao as A,eo as B,dt as C,Jn as D,Qn as E,Zn as F,Un as G,no as I,io as M,Vn as N,to as R,oo as S,ft as T,Xn as W,In as a,Hn as b,jn as c,ut as d,kn as e,An as f,Dn as g,Ln as h,Mn as i,Tn as j,Pn as k,Rn as l,ct as m,pt as n,ro as o,mt as p,ht as q,vt as r,Wn as s,Yn as t,$n as u,qn as v,Kn as w,zn as x,Bn as y,Gn as z};
