import{s as i,N as v,b as y,r as k,u as j,j as e,F as S,a as F,l as z,L as I}from"./index-d81440de.js";import{i as c,a as x}from"./eye-off-f08dcaf5.js";import{c as m,a}from"./index.esm-38e7689f.js";import{i as $}from"./welcomepage-690c85c9.js";const E=i.div`
  margin: 0 auto;
  padding: 10px;
...
`,N=m().shape({email:a().trim("Cannot include leading and trailing spaces").email("Invalid email").required("Required!"),password:a().trim("Cannot include leading and trailing spaces").min(6,"Too Short!").required("Required!")});i.div`
  ...
  gap: 10px;
  width: 100%;
`;const t={text:"#FFFFFF",inputBorder:"#45FFBC",inputBorderHover:"#21CE99",error:"#e74a3b",success:"#3cbc81",background:"transparent",iconStroke:"#FFFFFF"},l=i(y)`
...
`,Q=m().shape({email:a().required("Required").trim("Cannot include leading and trailing spaces").email("Invalid email address").matches(/^[\w-.]+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/i,"Invalid email address")}),U={email:"",password:""},Z=()=>{const[n,g]=k.useState(!1),h=j(),f=(r,o)=>{h(z(r)),o.resetForm()},u=()=>{g(!n)};return e.jsx(S,{initialValues:U,validationSchema:N,onSubmit:f,children:({errors:r,touched:o})=>{const b=o.email?r.email?"1px solid #e74a3b":"1px solid #3cbc81":"1px solid var(--primary-color-green-lite)",w=o.password?r.password?"1px solid #e74a3b":"1px solid #3cbc81":"1px solid var(--primary-color-green-lite)";return e.jsxs(F,{autoComplete:"off",children:[e.jsxs(V,{children:[e.jsx(p,{children:e.jsx(l,{border:b,type:n?"text":"password",name:"email",validate:Q,placeholder:"Email"})}),r.email&&o.email||!r.email&&o.email?e.jsx(d,{children:e.jsx(s,{color:!r.email&&o.email?"#3cbc81":null,children:r.email?r.email:"Success email"})}):null,e.jsxs(p,{children:[e.jsx(l,{border:w,type:n?"text":"password",name:"password",placeholder:"Password"}),e.jsx(D,{children:e.jsx(Y,{onClick:u,children:e.jsx("image",{href:n?c:x})})})]}),r.password&&o.password||!r.password&&o.password?e.jsx(d,{children:e.jsx(s,{color:!r.password&&o.password?"#3cbc81":null,children:r.password?r.password:"Success password"})}):null]}),e.jsx(H,{type:"submit",children:"Sign In"})]})}})},M=()=>e.jsxs(E,{children:[e.jsx(L,{src:$,alt:"Activity tracker"}),e.jsxs(C,{children:[e.jsxs(P,{children:[e.jsx(B,{children:"Sign in"}),e.jsx(q,{children:"You need to login to use the service"})]}),e.jsx(Z,{}),e.jsx(I,{to:"/forgot-password",children:e.jsx(T,{children:"Forgot your password?"})}),e.jsxs(W,{children:[e.jsx(R,{children:"If you do not have an account yet"}),e.jsx(A,{to:"/signup",children:"Sign up"})]})]})]});export{M as default};
