import{s as t,k as h,m as M,n as A,j as e,o as u,t as m,p as _,q as H,v as O,r as j,u as v,w as V,x as q,L,y as N,z as Z,A as J,B as K,C as Q}from"./index-4a195c2d.js";import{C as I,A as X,p as E,a as G,D as Y,b as ee,L as te,B as re,c as ie,d as ne}from"./index-caaa0024.js";import{R as oe}from"./RecommendedList-429b763e.js";import{s as ae,R as se,M as le,A as ce,a as de,b as pe,c as xe,d as he}from"./Record-e4e54a49.js";const ge=t.div`
  width: 300px;
...
`,Me=t.p`
  color: var(--primary-color-grey);
`,Ae=()=>{const r=`${m.palette.litegreen.main}`,i=`${m.palette.pink.main}`,o=`${m.palette.yellow.main}`,a=`${m.palette.grey.main}`,d=h(M),p=h(_),c=h(H),x=h(O),g=1360,f=136,w=119.5,y=38.8;return e.jsxs(ze,{children:[e.jsx(Pe,{children:"Food"}),e.jsxs(Be,{children:[e.jsxs(Re,{children:[e.jsx(U,{dailyGoal:d,filledValue:g,bgColor:r}),e.jsxs(Se,{children:[e.jsx(Te,{children:g}),e.jsx(Me,{children:"calories"})]})]}),e.jsxs(De,{children:[e.jsx(C,{children:e.jsx(k,{title:"Carbonohidrates",bgColor:i,dailyGoal:p,filledValue:f})}),e.jsx(C,{children:e.jsx(k,{title:"Protein",bgColor:o,dailyGoal:c,filledValue:w})}),e.jsx(C,{children:e.jsx(k,{title:"Fat",bgColor:a,dailyGoal:x,filledValue:y})})]})]})]})},Le=t.div`
  height: 100vh;
  width: 100vw;
...
`,gt=()=>e.jsxs(lt,{children:[e.jsxs(ct,{children:[e.jsx(pt,{children:"Today"}),e.jsxs(xt,{to:"/dashboard",children:["On the way to the goal",e.jsx(ht,{children:e.jsx("use",{href:`${u}#icon-arrowright`})})]})]}),e.jsxs(dt,{children:[e.jsx(be,{}),e.jsx(st,{}),e.jsx(Ae,{})]})]}),mt=t.div`
  padding-top: 20px;
  width: 300px;
  @media screen and (min-width: 834px) {
    width: 558px;
