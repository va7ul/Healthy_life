import{u as A,j as e,y as ie,as as N,at as ce,s as S,L as de,r as x,o as I,au as le,A as ue,k as F,D as he}from"./index-4dfbfae1.js";import{i as xe,C as pe,T as je,j as q,d as G,k as J,I as fe,R as me,l as ge,m as Ce,n as be,o as ye,p as ve,q as ke,r as we,t as Se,B as K,D as Q,L as V,S as X,u as Me,W as Pe,v as Fe,w as Ie,x as Re,y as T,z as Be,E as Le,P as De,F as Te,G as Ee,H as $e,J as Oe,K as Ae,N as H,O as Ne,Q as E,U as $,V as O,X as _e,Y as He,Z as We,_ as W,A as z,$ as U,M as ze,e as Ue,f as qe,g as Ge,h as Je,a0 as Ke}from"./MealPopUpModal-8eec368f.js";const Qe=({type:m,name:d,calories:C,carbogidrate:u,protein:a,fat:o,productId:i,setName:l,setCalories:M,setCarbogidrate:p,setProtein:P,setFat:j})=>{const b=A(),h=()=>{b(N(!1))},y={typeFood:m,userFood:{name:d,calories:C,nutrition:{carbogidrate:u,protein:a,fat:o}}},f=n=>{n.preventDefault(),b(ce({id:i,food:y})),h()},v=n=>{if(n==="breakfast")return K;if(n==="dinner")return Q;if(n==="lunch")return V;if(n==="snack")return X};return e.jsx(xe,{onClick:h,children:e.jsxs(pe,{onClick:n=>n.stopPropagation(),children:[e.jsx(je,{children:"Record your meal"}),e.jsxs(q,{style:{marginTop:"24px"},children:[e.jsx(G,{src:v(m)}),e.jsx(J,{children:ie(m)})]}),e.jsxs("form",{onSubmit:f,children:[e.jsxs(fe,{children:[e.jsx(me,{value:d,type:"string",placeholder:"The name of the product or dish",onChange:n=>{l(n.target.value)}}),e.jsx(ge,{min:0,max:100,type:"number",onChange:n=>{p(n.target.value)},value:u,placeholder:"Carbonoh"}),e.jsx(Ce,{min:0,max:100,type:"number",onChange:n=>{P(n.target.value)},value:a,placeholder:"Protein"}),e.jsxs(be,{children:[e.jsx(ye,{min:0,max:100,type:"number",onChange:n=>{j(n.target.value)},value:o,placeholder:"Fat"}),e.jsx(ve,{min:0,max:400,type:"number",onChange:n=>{M(n.target.value)},value:C,placeholder:"Calories"})]})]}),e.jsxs(ke,{children:[e.jsx(we,{type:"submit",children:"Confirm"}),e.jsx(Se,{onClick:h,type:"button",children:"Cancel"})]})]})]})})},Ve=S(de)``,Xe=S.svg`
