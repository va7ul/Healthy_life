import{s as t,k as x,m as A,n as I,j as e,o as y,t as m,p as Z,q as J,v as K,r as $,u as W,w as O,x as Q,L as X,y as Y,z as ee,A as te}from"./index-f9b977ff.js";import{C as E,A as ie,p as G,a as U,D as re,b as ne,L as oe,B as se,c as ae,d as le}from"./index-239956fd.js";import{R as ce}from"./RecommendedList-e10261ed.js";import{s as de,a as pe,b as xe,c as he,M as j,A as w}from"./Reacord.styled-25e2246f.js";const ge=t.div`
  width: 300px;
...
`,Fe=t.div`
  ...
  color: var(--primary-color-grey);
`,P=({title:i,bgColor:n,dailyGoal:a,filledValue:l})=>{let d=Math.round(l*100/a),p=(a-l).toFixed(0);return l>a&&(p=0),d>100&&(d=100),e.jsxs(Ce,{children:[e.jsxs(ke,{children:[e.jsx(_,{dailyGoal:a,filledValue:l,bgColor:n}),e.jsx(Fe,{children:e.jsx("p",{children:`${d}%`})})]}),e.jsxs("div",{children:[e.jsx(We,{children:i}),e.jsxs($e,{children:[e.jsxs("p",{children:["Goal: ",e.jsx(M,{children:a})]}),e.jsxs("p",{children:["left: ",e.jsx(M,{children:p})]})]})]})]})},ze=t.div`
  width: 300px;
...
`,Me=t.p`
  color: var(--primary-color-grey);
`,Le=()=>{const i=`${m.palette.litegreen.main}`,n=`${m.palette.pink.main}`,a=`${m.palette.yellow.main}`,l=`${m.palette.grey.main}`,d=x(A),p=x(Z),c=x(J),g=x(K),u=1360,F=136,z=119.5,D=38.8;return e.jsxs(ze,{children:[e.jsx(Be,{children:"Food"}),e.jsxs(De,{children:[e.jsxs(Re,{children:[e.jsx(_,{dailyGoal:d,filledValue:u,bgColor:i}),e.jsxs(Se,{children:[e.jsx(Te,{children:u}),e.jsx(Me,{children:"calories"})]})]}),e.jsxs(Pe,{children:[e.jsx(B,{children:e.jsx(P,{title:"Carbonohidrates",bgColor:n,dailyGoal:p,filledValue:F})}),e.jsx(B,{children:e.jsx(P,{title:"Protein",bgColor:a,dailyGoal:c,filledValue:z})}),e.jsx(B,{children:e.jsx(P,{title:"Fat",bgColor:l,dailyGoal:g,filledValue:D})})]})]})]})},Ae=t.div`
  height: 100vh;
  width: 100vw;
...
`,st=t.p`
  ...
  font-weight: 600;
  line-height: 22px;
`,at=()=>{const[i,n]=$.useState(!1),a=W(),l=x(Je),d=x(I),p=x(Ze),c=p<=d?Math.round(p*100/d):100;let g=d-p;p>d&&(g=0);const u={color:c>85?`${m.palette.greyone.main}`:`${m.palette.violet.main}`};return e.jsxs(Ke,{children:[e.jsx(Oe,{children:"Water"}),e.jsxs(Qe,{children:[e.jsx(tt,{width:"20px",height:"20px",onClick:()=>{a(Q(l))},children:e.jsx("use",{href:`${y}#trash-delete`})}),e.jsx(nt,{children:e.jsxs(ot,{children:[e.jsx(Ne,{waterIntake:c}),e.jsx(st,{style:u,children:`${c}%`})]})}),e.jsxs("div",{children:[e.jsx(Xe,{children:"Water consumption"}),e.jsxs(L,{children:[e.jsx(et,{children:p}),"ml"]}),e.jsxs(L,{children:[e.jsx(Ye,{children:"left:"})," ",`${g} ml`]}),e.jsxs(rt,{type:"button",onClick:()=>n(!0),children:[e.jsx(it,{children:e.jsx("use",{href:`${y}#icon-add-converted`})}),"Add water intake"]})]})]}),i&&e.jsx(Ve,{setIsModalOpen:n,isModalOpen:i})]})},lt=t.div`
  margin: 0 auto;
  max-width: 300px;
