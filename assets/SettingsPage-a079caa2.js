import{r as z,s as n,R as K,V as Q,W as Z,I as h,ak as S,$ as ee,_ as oe,j as e,as as te,at as ae,J as ie,a2 as s,a3 as re,c as ne,a as E,e as L,au as le,t as W,d as se,F as de,u as ue,k as A,av as pe,aw as ce,ax as ge,b as he,o as xe,ah as V,X as D,ay as H,az as m,aA as v,aB as U,aC as me}from"./index-9cc94058.js";import{c as ve}from"./dashboardSelectors-14fa5b63.js";function be(a){return z.Children.toArray(a).filter(o=>z.isValidElement(o))}const fe="/Healthy_life/assets/settings-page-image-b0655153.png",ye=n.div`
  padding-bottom: 40px;
...
`;let $;const Ne=()=>{const a=ue(),o=A(pe),{name:r,avatar:p,age:j,gender:B,height:d,weight:u,activityLevel:x}=o,t=ce({initialValues:(()=>({name:r,avatar:p,age:j,gender:B,height:d,weight:u,activityLevel:x}))(),validationSchema:Pe,onSubmit:c=>{t.values.activityLevel=Number(c.activityLevel);let l=new FormData;l.append("avatar",t.values.avatar),l.append("name",t.values.name),l.append("age",t.values.age),l.append("gender",t.values.gender),l.append("height",t.values.height),l.append("weight",t.values.weight),l.append("activityLevel",t.values.activityLevel),a(ge(l))}});return e.jsx(he,{children:e.jsxs(We,{onSubmit:t.handleSubmit,autoComplete:"off",children:[e.jsxs(w,{htmlFor:"name",children:["Your name",e.jsx(F,{id:"name",name:"name",value:t.values.name,onChange:t.handleChange}),t.errors.name&&t.touched.name&&e.jsx(g,{id:"feedback",name:"name",children:t.errors.name})]}),e.jsxs(w,{children:["Your photo",e.jsxs(Te,{children:[e.jsx(Me,{src:t.values.avatar?p:URL.createObjectURL(t.values.avatar),alt:"user avatar",file:t.values.avatar}),e.jsxs(Ee,{type:"button",htmlFor:"avatar",children:[e.jsx(De,{id:"avatar",name:"avatar",type:"file",accept:"image/png, .svg, .jpg, .gif, .jpeg, .webp",onChange:c=>{if(!c.currentTarget.files){console.log("No image selected");return}$=c.currentTarget.files[0],t.setFieldValue("avatar",$),console.log($)}}),e.jsx(Ie,{children:e.jsx("use",{href:`${xe}#icon-direct-inbox`})}),e.jsx(Ve,{children:$?t.values.avatar.name:"Download new photo"})]})]})]}),e.jsxs(w,{htmlFor:"age",children:["Your age",e.jsx(F,{id:"age",name:"age",type:"number",value:t.values.age,onChange:t.handleChange}),t.errors.age&&t.touched.age&&e.jsx(g,{id:"feedback",name:"age",children:t.errors.age})]}),e.jsxs(V,{sx:He,children:[e.jsx(D,{id:"gender",sx:N,children:"Gender"}),e.jsxs(H,{row:!0,sx:{gap:"16px"},"aria-labelledby":"gender",name:"gender",value:t.values.gender,onChange:t.handleChange,children:[e.jsx(m,{value:"male",sx:b,control:e.jsx(v,{sx:f}),label:"Male"}),e.jsx(m,{value:"female",sx:b,control:e.jsx(v,{sx:f}),label:"Female"}),t.errors.gender&&t.touched.gender&&e.jsx(g,{id:"feedback",name:"gender",children:t.errors.gender})]})]}),e.jsxs(w,{htmlFor:"height",children:["Height",e.jsx(F,{id:"height",name:"height",type:"number",value:t.values.height,onChange:t.handleChange}),t.errors.height&&t.touched.height&&e.jsx(g,{id:"feedback",name:"height",children:t.errors.height}),e.jsx(g,{name:"height",component:"span"})]}),e.jsxs(w,{htmlFor:"weight",children:["Weight",e.jsx(F,{id:"weight",name:"weight",type:"number",value:t.values.weight,onChange:t.handleChange}),t.errors.weight&&t.touched.weight&&e.jsx(g,{id:"feedback",name:"weight",children:t.errors.weight}),e.jsx(g,{name:"weight",component:"span"})]}),e.jsxs(V,{sx:{gap:"12px"},children:[e.jsx(D,{id:"activityLevel",sx:N,children:"Your activity"}),e.jsxs(H,{row:!0,sx:{gap:"16px"},"aria-labelledby":"activityLevel",name:"activityLevel",type:"number",value:t.values.activityLevel,onChange:t.handleChange,children:[e.jsx(m,{value:"1.2",sx:b,control:e.jsx(v,{sx:f}),label:"1.2 - if you do not have physical activity and sedentary work"}),e.jsx(m,{value:"1.375",sx:b,control:e.jsx(v,{sx:f}),label:`1.375 - if you do short runs or light gymnastics 1-3 times a
                  ...
                  program`}),t.errors.activityLevel&&t.touched.activityLevel&&e.jsx(g,{id:"feedback",name:"activityLevel",children:t.errors.activityLevel})]})]}),e.jsxs(Ge,{"aria-label":"button group",sx:Ue,children:[e.jsx(U,{sx:O,type:"submit",children:"Save"}),e.jsx(U,{sx:O,onClick:(t.resetForm,$=null),children:"Cancel"})]})]})})},Oe=()=>e.jsxs(ye,{children:[e.jsx(je,{children:"Profile setting"}),e.jsxs(Be,{children:[e.jsx(Ce,{src:fe,alt:"Page image"}),e.jsx(Ne,{})]})]}),_e=()=>{const a=A(ve);return e.jsx(e.Fragment,{children:a?me:e.jsx(Oe,{})})};export{_e as default};
