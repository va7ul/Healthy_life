import{r as s,s as t,N as J,j as e,u as K,a as X}from"./index-62072c66.js";import{n as T}from"./notiflix-notify-aio-8b0d90ea.js";import{i as Z}from"./welcomepage-690c85c9.js";import{i as ee,a as te}from"./eye-off-ba3479c3.js";import{c as k,a as W,F as S,b as A,d as i,E as u,e as w}from"./index.esm-c004c498.js";const $=(n="",o={})=>{const[l,p]=s.useState(n),[d,c]=s.useState(null),[m,r]=s.useState(!1),x=()=>{if(!o)return;const{required:f,minLength:h,maxLength:b,pattern:y}=o;f&&!l.trim()?c("This field is required"):h&&l.length<h?c(`Minimum length is ${h} characters`):b&&l.length>b?c(`Maximum length is ${b} characters`):y&&!y.test(l)?c("Invalid format"):c(null)};return{value:l,error:d,touched:m,onChange:f=>{p(f.target.value),m&&x()},onBlur:()=>{r(!0),x()}}},ne=()=>{const n=document.getElementById("myInput");n.type==="password"?n.type="text":n.type="password"},ie=t.div`
  margin: 0 auto;
  padding: 10px;
