...
`;let C;const De=()=>{var f;const a=ne(),o=F.useRef(((f=a.state)==null?void 0:f.from)??"/main"),r=le(se),{name:g,avatar:$,age:w,gender:d,height:p,weight:h,activityLevel:R}=r,t=he({initialValues:{name:g,avatar:"",age:w,gender:d,height:p,weight:h,activityLevel:R},validationSchema:we,onSubmit:y=>{t.values.activityLevel=Number(y.activityLevel);let l=new FormData;C&&l.append("avatar",t.values.avatar),l.append("name",t.values.name),l.append("age",t.values.age),l.append("gender",t.values.gender),l.append("height",t.values.height),l.append("weight",t.values.weight),l.append("activityLevel",t.values.activityLevel);for(let j of l.entries())console.log(j[0]+", "+j[1]),C=null}});return e.jsxs(ke,{children:[e.jsx(Le,{children:"Profile setting"}),e.jsxs(Fe,{children:[e.jsx(ze,{src:Re,alt:"Page image"}),e.jsx(xe,{children:e.jsxs(Ge,{onSubmit:t.handleSubmit,children:[e.jsxs(L,{htmlFor:"name",children:["Your name",e.jsx(T,{id:"name",name:"name",value:t.values.name,onChange:t.handleChange}),t.errors.name&&t.touched.name&&e.jsx(u,{id:"feedback",name:"name",children:t.errors.name})]}),e.jsxs(L,{children:["Your photo",e.jsxs(Te,{children:[e.jsx(Pe,{src:C?URL.createObjectURL(t.values.avatar):$,alt:"user avatar",file:t.values.avatar}),e.jsxs(Me,{type:"button",htmlFor:"avatar",children:[e.jsx(Ee,{id:"avatar",name:"avatar",type:"file",accept:"image/png, .svg, .jpg, .gif, .jpeg, .webp",onChange:y=>{y.currentTarget.files&&(C=y.currentTarget.files[0],t.setFieldValue("avatar",C))}}),e.jsx(We,{children:e.jsx("use",{href:`${de}#icon-direct-inbox`})}),e.jsx(He,{children:C?t.values.avatar.name:"Download new photo"})]})]})]}),e.jsxs(L,{htmlFor:"age",children:["Your age",e.jsx(T,{id:"age",name:"age",type:"number",value:t.values.age,onChange:t.handleChange}),t.errors.age&&t.touched.age&&e.jsx(u,{id:"feedback",name:"age",children:t.errors.age})]}),e.jsxs(I,{sx:Ie,children:[e.jsx(V,{id:"gender",sx:A,children:"Gender"}),e.jsxs(D,{row:!0,sx:{gap:"16px"},"aria-labelledby":"gender",name:"gender",value:t.values.gender,onChange:t.handleChange,children:[e.jsx(x,{value:"male",sx:v,control:e.jsx(m,{sx:b}),label:"Male"}),e.jsx(x,{value:"female",sx:v,control:e.jsx(m,{sx:b}),label:"Female"}),t.errors.gender&&t.touched.gender&&e.jsx(u,{id:"feedback",name:"gender",children:t.errors.gender})]})]}),e.jsxs(L,{htmlFor:"height",children:["Height",e.jsx(T,{id:"height",name:"height",type:"number",value:t.values.height,onChange:t.handleChange}),t.errors.height&&t.touched.height&&e.jsx(u,{id:"feedback",name:"height",children:t.errors.height}),e.jsx(u,{name:"height",component:"span"})]}),e.jsxs(L,{htmlFor:"weight",children:["Weight",e.jsx(T,{id:"weight",name:"weight",type:"number",value:t.values.weight,onChange:t.handleChange}),t.errors.weight&&t.touched.weight&&e.jsx(u,{id:"feedback",name:"weight",children:t.errors.weight}),e.jsx(u,{name:"weight",component:"span"})]}),e.jsxs(I,{sx:{gap:"12px"},children:[e.jsx(V,{id:"activityLevel",sx:A,children:"Your activity"}),e.jsxs(D,{row:!0,sx:{gap:"16px"},"aria-labelledby":"activityLevel",name:"activityLevel",type:"number",value:t.values.activityLevel,onChange:t.handleChange,children:[e.jsx(x,{value:"1.2",sx:v,control:e.jsx(m,{sx:b}),label:"1.2 - if you do not have physical activity and sedentary work"}),e.jsx(x,{value:"1.375",sx:v,control:e.jsx(m,{sx:b}),label:`1.375 - if you do short runs or light gymnastics 1-3 times a
                  ...
                  program`}),t.errors.activityLevel&&t.touched.activityLevel&&e.jsx(u,{id:"feedback",name:"activityLevel",children:t.errors.activityLevel})]})]}),e.jsxs($e,{"aria-label":"button group",sx:Ve,children:[e.jsx(O,{sx:N,type:"submit",children:"Save"}),e.jsx(O,{sx:N,children:e.jsx(pe,{to:o.current,children:"Cancel"})})]})]})})]})]})},Ae=()=>e.jsx(e.Fragment,{children:e.jsx(De,{})});export{Ae as default};
