import{q as me,v as ye,r as x,w as ve,x as Ce,_ as k,j as o,y as h,z as T,A as j,B as we,T as Fe,C as Me,D as ke,t as v,F as Te,I as je,S as Re,M as Be,s as u,e as C,E as R,G as B,H as S,J as $,K as F,O as Se,P as A,Q as $e,L as ze,R as Ae,u as Pe,U as Le,b as De,V as q}from"./index-62072c66.js";import{C as ee,b as te,L as oe,P as ne,e as se,c as ae,p as ie,i as le,a as re,f as de}from"./index-b10e26a8.js";const He=["className","component"];function We(e={}){const{themeId:t,defaultTheme:n,defaultClassName:s="MuiBox-root",generateClassName:i}=e,a=me("div",{shouldForwardProp:r=>r!=="theme"&&r!=="sx"&&r!=="as"})(ye);return x.forwardRef(function(g,c){const l=ve(n),p=Ce(g),{className:m,component:b="div"}=p,y=k(p,He);return o.jsx(a,h({as:b,ref:c,className:T(m,i?i(s):s),theme:t&&l[t]||l},y))})}const Ne=j("MuiBox",["root"]),Oe=Ne,Ie=we(),Ee=We({themeId:Fe,defaultTheme:Ie,defaultClassName:Oe.root,generateClassName:Me.generate}),Ue=Ee,_e=ke`
...
`;function N(e){if((e==null?void 0:e.length)===0)return 0;const n=(e==null?void 0:e.reduce((s,i)=>s+i.value,0))/(e==null?void 0:e.length);return Math.round(n)}function O(e){if(e)return e.indexOf("/")===-1?e:e.slice(e.indexOf("/")+1,e.length)}const Xt=new Date;let Zt=M[Xt.getMonth()];const eo=()=>{var y;const e=C(ce),t=C(pe),n=C(ge),s=C(Ge),i=C(Ke),a=Ae(),d=((y=a==null?void 0:a.state)==null?void 0:y.from)??"/",r=Pe(),[g,c]=Le(),l=g.get("queryMonth"),[p,m]=x.useState(O(l)??Zt);x.useEffect(()=>{async function w(){try{r(l?q(M.indexOf(O(l))+1):q(M.indexOf(O(p))+1))}catch(f){console.log("error",f)}}w()},[p,l,r]);const b=w=>{const f=w.target.value;c({queryMonth:`${Date.now()}/${f}`}),m(f)};return o.jsxs(o.Fragment,{children:[s?o.jsx("p",{children:"Oops! Loading....."}):!i&&o.jsxs(Jt,{children:[o.jsxs(Vt,{children:[o.jsxs(qt,{children:[o.jsx(Yt,{type:"button",children:o.jsx(Gt,{to:d,children:o.jsx(Kt,{children:o.jsx("use",{href:`${De}#icon-arrowright`})})})}),o.jsx(Ve,{month:p,onChange:b})]}),o.jsx(Ye,{month:p})]}),o.jsxs(Qt,{children:[o.jsxs(P,{children:[o.jsxs(L,{children:[o.jsx(D,{children:" Calories "}),o.jsxs(H,{children:["Average value:"," ",o.jsxs(W,{children:[N(e)," cal"]})]})]}),o.jsx(Z,{children:o.jsx(tt,{month:p})})]}),o.jsxs(P,{children:[o.jsxs(L,{children:[o.jsx(D,{children:" Water "}),o.jsxs(H,{children:["Average value:"," ",o.jsxs(W,{children:[N(t)," ml"]})]})]}),o.jsx(Z,{children:o.jsx(nt,{month:p})})]})]}),o.jsxs(P,{children:[o.jsxs(L,{children:[o.jsx(D,{children:" Weight "}),o.jsxs(H,{children:["Average value:"," ",o.jsxs(W,{children:[N(n)," kg"]})]})]}),o.jsx(_t,{month:p})]})]}),i&&!s&&o.jsx("p",{children:"Oops! Something went wrong!"})]})},no=()=>o.jsx(eo,{});export{no as default};
