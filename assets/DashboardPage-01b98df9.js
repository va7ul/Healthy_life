import{x as ye,y as ve,r as h,z as Ce,A as we,_ as k,j as o,B as x,C as j,D as T,G as Fe,T as Me,H as ke,I as je,t as m,J as Te,K as Re,S as $e,M as Be,s as g,g as C,O as R,P as $,Q as B,R as S,U as M,V as Se,W as A,X as ze,L as Ae,Y as De,u as Pe,Z as We,k as Le,$ as X}from"./index-bb71dcd0.js";import{C as ne,b as se,L as ae,P as ie,e as le,c as re,p as de,i as ce,a as pe,f as ue}from"./index-a231b6e2.js";const He=["className","component"];function Oe(e={}){const{themeId:t,defaultTheme:s,defaultClassName:n="MuiBox-root",generateClassName:a}=e,i=ye("div",{shouldForwardProp:d=>d!=="theme"&&d!=="sx"&&d!=="as"})(ve);return h.forwardRef(function(u,l){const r=Ce(s),p=we(u),{className:y,component:b="div"}=p,v=k(p,He);return o.jsx(i,x({as:b,ref:l,className:j(y,a?a(n):n),theme:t&&r[t]||r},v))})}const Ne=T("MuiBox",["root"]),Ie=Ne,Ee=Fe(),Ue=Oe({themeId:Me,defaultTheme:Ee,defaultClassName:Ie.root,generateClassName:ke.generate}),_e=Ue,Ye=je`
