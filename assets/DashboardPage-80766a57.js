import{q as me,v as ye,r as h,w as ve,x as Ce,_ as k,j as o,y as x,z as T,A as j,B as we,T as Fe,C as Me,D as ke,t as v,F as Te,I as je,S as Re,M as $e,s as u,e as C,E as R,G as $,H as S,J as B,K as M,O as Se,P as A,Q as Be,L as ze,R as Ae,u as De,U as Pe,b as Le,V as q}from"./index-fa623c81.js";import{C as oe,b as ne,L as se,P as ae,e as ie,c as le,p as re,i as ce,a as de,f as pe}from"./index-95552483.js";const We=["className","component"];function He(e={}){const{themeId:t,defaultTheme:s,defaultClassName:n="MuiBox-root",generateClassName:a}=e,i=me("div",{shouldForwardProp:c=>c!=="theme"&&c!=="sx"&&c!=="as"})(ye);return h.forwardRef(function(g,l){const r=ve(s),p=Ce(g),{className:m,component:b="div"}=p,y=k(p,We);return o.jsx(i,x({as:b,ref:l,className:T(m,a?a(n):n),theme:t&&r[t]||r},y))})}const Oe=j("MuiBox",["root"]),Ne=Oe,Ie=we(),Ee=He({themeId:Fe,defaultTheme:Ie,defaultClassName:Ne.root,generateClassName:Me.generate}),Ue=Ee,_e=ke`
