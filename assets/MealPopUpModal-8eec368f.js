...
`,Ao="/Healthy_life/assets/Breakfast-ebbae9d6.png",Do="/Healthy_life/assets/Dinner-3e075f11.png",Lo="/Healthy_life/assets/Lunch-b9834f5c.png",Io="/Healthy_life/assets/Snack-986b08ce.png",Uo={content:{maxWidth:"calc(100vw + 20px)",maxHeight:"calc(100vh - 24px)",top:"50%",left:"50%",right:"auto",bottom:"auto",marginRight:"-50%",transform:"translate(-50%, -41%)",background:"#0F0F0F",padding:"16px 12px",borderRadius:"12px",borderColor:"#0F0F0F"},overlay:{backgroundColor:"rgba(0, 0, 0, 0.8)",zIndex:"1200",width:"100vw",height:"100vh"}};We.setAppElement("#root");const Tn=({stateModal:t,closeModal:e,typefood:n})=>{const a=Xe(),i={name:"",carbogidrate:"",protein:"",fat:"",calories:""},h=r=>{let y={typeFood:n,userFood:r.products.map(f=>({name:f.name,calories:f.calories,nutrition:{carbogidrate:f.carbogidrate,protein:f.protein,fat:f.fat}}))};a(nt(y)),e()},b=r=>{if(r==="breakfast")return Ao;if(r==="dinner")return Do;if(r==="lunch")return Lo;if(r==="snack")return Io};return v.jsx(We,{isOpen:t,onRequestClose:e,style:Uo,children:v.jsxs(Fo,{children:[v.jsx(dt,{children:"Record your meal"}),v.jsxs(st,{style:{marginTop:"24px"},children:[v.jsx(pt,{src:b(n),alt:n}),v.jsx(ct,{children:Ze(n)})]}),v.jsx(et,{initialValues:{products:[i]},onSubmit:r=>h(r),children:({values:r})=>v.jsxs(tt,{children:[v.jsx(ot,{name:"products",children:({remove:y,push:f})=>v.jsxs(No,{children:[r.products.map((x,s)=>v.jsxs(Eo,{children:[v.jsx(wo,{name:`products.${s}.name`,placeholder:"The name of the product or dish",value:r.products[s].name}),v.jsx(Oo,{name:`products.${s}.carbogidrate`,placeholder:"Carbonoh.",value:r.products[s].carbogidrate,type:"number",min:0,max:200}),v.jsx(Co,{name:`products.${s}.protein`,placeholder:"Protein",value:r.products[s].protein,min:0,max:200,type:"number"}),v.jsxs(ko,{children:[v.jsx(_o,{name:`products.${s}.fat`,placeholder:"Fat",value:r.products[s].fat,min:0,max:200,type:"number"}),v.jsx(So,{name:`products.${s}.calories`,placeholder:"Calories",value:r.products[s].calories,min:0,max:3e3,type:"number"}),v.jsx(Ro,{"data-set":s,type:"button",onClick:m=>{const g=m.currentTarget.dataset.set;r.products.length===1&&e(),y(g)},children:v.jsx("svg",{style:{display:"inline-block",width:"20px",height:" 20px",fill:"#E3FFA8"},children:v.jsx("use",{href:`${ye}#trash-delete`})})})]})]},s)),v.jsxs(Mo,{type:"button",onClick:()=>f(i),children:[v.jsx(Po,{children:v.jsx("use",{href:`${ye}#icon-add-converted`})}),"Add more"]})]})}),v.jsxs(ut,{children:[v.jsx(ft,{type:"submit",children:"Confirm"}),v.jsx(To,{onClick:e,type:"button",children:"Cancel"})]})]})})]})})};export{xn as $,Mn as A,Ao as B,wn as C,Do as D,Zo as E,tn as F,on as G,rn as H,kn as I,pn as J,dn as K,Lo as L,Tn as M,sn as N,fn as O,en as P,hn as Q,On as R,Io as S,dt as T,un as U,an as V,Go as W,mn as X,vn as Y,yn as Z,gn as _,Ko as a,zo as a0,Vo as b,Yo as c,pt as d,Ho as e,jo as f,$o as g,Bo as h,bn as i,st as j,ct as k,Cn as l,_n as m,Pn as n,Sn as o,En as p,ut as q,ft as r,qo as s,Rn as t,cn as u,Jo as v,Qo as w,Xo as x,nn as y,ln as z};
